...
- **Recommendations** — discover books through Open Library, optionally enriched by Google Books, using your authors, tags, genres, favorites and listening history; exclude broad tag families, restrict results to a preferred language, and open an in-app page for synopsis and tags
